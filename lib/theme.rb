class Theme
  COMPONENTS = {
    ...
    dropdown: {
      ...
      toggle: "justify-between focus:ring-0",
  ...
  class << self
    ...
    def get(component, *elements)
      ...
      if elements.empty?
        return components[component.to_sym]
      end

      data = components.dig(component.to_sym, *elements)
    ...
    #
    # @param component [Symbol, String] the component to retrieve
    ...
    #
    # @param component [Symbol, String] the name of the component to validate.
    # @return [void]
  ...
  class ComponentProcessor
    ...
    def initialize(component, options, default_classes)
      ...
      @processed_elements = []
      @current_component = component.to_sym
      @tw_merger = nil
    end
    ...
    private
      ...
      def fetch_component_data
        ...
        Theme.get(@current_component, *elements)
      end
      ...
      def process_component_hash(component_data, options, default_classes, element_path)
        ...
        if component_data[:opts]
          Theme.validate_options!(options, @current_component, *element_path[1..])
